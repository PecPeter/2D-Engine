...
class cCntrlKb {
	public:
		...
		void addCommand (T action, SDL_Keycode keyCode, bool repeatCommand=true, int modCode=KMOD_NONE);
		void addCommand (T action, std::vector<SDL_Keycode>& keyCodes,
				bool repeatCommand=true, int modCode=KMOD_NONE);
...
template <class T>
void cCntrlKb<T>::addCommand (T action, std::vector<SDL_Keycode>& keyCodes, bool repeatCommand, int modCode) {
